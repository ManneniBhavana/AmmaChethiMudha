...
const Home = () => {
  return (
    <div className='home-container'>
      ...
      <p className='quote'>
        "Amma Chethi Mudha is more than just a cooking and recipe app that
        provides authentic Indian recipes. It's a one-stop app for all the
        learners and enthusiasts community. Enthusiasts can upload their
        culinary creations and kitchen wisdom into the app. Learners can find
        the recipes and start their cooking journey with all the information
        provided. Amma Chethi Mudha offers a library of recipes at your
        fingertips."
      </p>
